...
for p in part:
    ...
    raw = mne.io.read_raw_fif(opj(indir,
                                  p + '_task-fearcond_cleanedeeg_cues_raw.fif'),
                              preload=True)
    ...
    report.add_figs_to_section(fig, captions='Drop log', section='Drop log')
    ...
    raw_s = mne.io.read_raw_fif(opj(indir,
                                    p + '_task-fearcond_cleanedeeg_shocks_raw.fif'),
                                preload=True)
