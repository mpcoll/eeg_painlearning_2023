function comp_compare_families()
%% %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Paths
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
clc;clear;
...
p.customfuncpath = ['/media/mp/mpx6/2023_painlerarnign_validate/code/compmodels'];
% Where is the data
p.datafile =  ['/media/mp/mpx6/2023_painlerarnign_validate/derivatives'...
                '/task-fearcond_scr_glmresp_processed.mat'];
% Ouput path
m.path = '/media/mp/mpx6/2023_painlerarnign_validate/derivatives/computational_models';;
if ~exist(m.path, 'dir')
   mkdir(m.path)
end
...
p.comparison_name = 'comp_families_';
...
p.to_compare =  {'RW_nointercue', 'PH_nointercue',...
                 'HGF2_nointercue_vhat_sa1hat', 'RW_intercue', 'PH_intercue_vhat_assoc',...
                 'HGF2_intercue_vhat_sa1hat'};
% Families (IN ORDER OF APPEARANCE BELOW)
p.comp_families = {[1, 2, 3], [4, 5, 6]};
